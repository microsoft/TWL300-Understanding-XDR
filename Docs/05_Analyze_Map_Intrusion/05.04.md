---
title: '04: Correlate multi-signal activity into a single Advanced Hunting timeline'
layout: default
nav_order: 4
parent: 'Exercise 05: Analyze and Map a Multi-Stage Intrusion'
---

## Task 04: Correlate multi-signal activity into a single Advanced Hunting timeline

1. Copy the following KQL into the query window, then select **Run query**.

    <details markdown='block'>
    <summary>
    Expand here to copy KQL-4.txt
    </summary>
    ...
    ![Intrusion-5.png](../../media/Intrusion-5.png)

    {: .note }
    > This query stitches together signals from:
    > - **Defender for Office 365** (email + Safe Links)  
    > - **Defender for Endpoint** (device processes)  
    > - **Identity** (AAD sign-ins)  
    > - **Defender for Cloud Apps**  

    {: .highlight }
    > Look for activity clusters around a **single user**, ordered over time — this helps tell a forensic “story”.
