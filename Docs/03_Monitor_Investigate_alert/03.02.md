---
title: '02: Create the lab alert + incident with a Custom detection rule / Detect password spray attempts'
layout: default
nav_order: 2
...
## Task 02: Create the lab alert + incident with a Custom detection rule / Detect password spray attempts
